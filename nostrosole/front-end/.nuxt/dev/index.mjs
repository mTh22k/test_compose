import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///app/node_modules/node-fetch-native/dist/polyfill.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","htmlAttrs":{"lang":"pt-br"},"titleTemplate":"%s","title":"nostrosole"};
